...
✨ 업스테이지 Solar Open 2 모델을 활용한 여러 에이전트 하네스 시험: Claude Code, Hermes Agent, Claude Agent SDK, LangChain Deepagents, OpenWiki, Grok Build, 그리고 Kubernetes 위의 Hermes Agent까지
...
| [Case 07 — Solar Open 2 x Hermes Agent Helm](07-hermes-agent-helm-solar-open2/) | Extend | `hermes-agent-helm` Helm 차트로 kind 클러스터에 Hermes Agent를 배포하고 Solar Open 2 도달 여부 검증 | 검증 완료 |
